...
class TestBitFinishDayPage:
    ...
    def test_finish_bit_day(self, browser):
        ...
        self.bit_page.should_be_popup_user_window_with_specified_button(PresetData.BUTTON_FINISH)
        self.bit_page.select_specified_button_in_user_window_popup(PresetData.BUTTON_FINISH)
        self.bit_page.should_be_specified_popup_window_after(PresetData.BUTTON_FINISH, PresetData.BUTTON_CONTINUE)
